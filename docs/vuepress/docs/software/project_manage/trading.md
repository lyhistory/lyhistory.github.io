...
名义交易量 (Notional Trading Volume)
实际交易量 (Actual Trading Volume)

假设一位交易员有 $10,000本金，他使用 10倍杠杆​ 进行交易：
    名义交易量：他控制的总头寸价值为 $10,000 * 10 = $100,000。这 $100,000就会被计入名义交易量。
    实际交易量：真正来自他口袋并在这个交易中流动的资金，是他的本金 $10,000。
