...
external_url 'http://172.26.101.133:80'
...
gitlab_rails['ldap_servers'] = {
  'main' => {
    ...
    'bind_dn' => 'CN=s-git,CN=Users,DC=lyhistory,DC=com',
    'password' => '123',
    'active_directory' => true,
    'base' => 'OU=Staff,DC=lyhistory,DC=com',
  }
}
...
git_data_dirs({
  "default" => {
    "gitaly_address" => "tcp://172.26.101.135:2305",
