...
## history
	                         How Computer Work
公元前30000年    旧石器时代的人们通过在动物骨骼、象牙、石块上刻下点数痕迹记录文字。
公元前3400年      埃及人发明了数字10的符号，简化了大数字的表示。
公元前2600年      中国人采用了算盘。
公元前300年       欧几里德的几何原理成为其后2000年的基础数学教科书，概括了希腊人所有的数学知识。
公元前260年       玛雅人发展了复杂的以20为基的数学体系，其中包括0。
公元1500年         达芬奇发明了机械计算机。
公元1621年         William Ougtred发明了计算尺，几乎使用了350年。
公元1642年         法国数学家Blaise Pascal发明了第一台自动机械计算机，称为Pascaline，只能进行加减法，必须用手转动设备。
公元1670年         Gottfied Lebniz改进了Pascal的算术机器，添加了乘除法和平方根的功能。
公元1679年         Lebniz采用了二进制运算。
公元1821年         Charles Babbage发明了差分机，这是可以进行加减运算的大型机械计算机。
公元1890年         由于人口迅速增长，美国人口统计署首次面对数据处理危机。Herman Hollerith使用穿孔卡创建了电子制表系统。
公元1896年         Hollerith组建了Tabulating Machine Company，这便是后来的IBM（International Business Machines，国际商用机器公司）。
1904年                                   John Ambrose Fleming研制出真空电子管。
1926年    	       首次出现半导体晶体管专利。晶体管允许电流通过计算机，使得数据在机
器中传送。
1936年    	       德国人Konrad Zuse创建了程序控制的数字计算机器，推出了使用二进制
系统和真空电子管这类重要概念。
1943年—1945年 美国军方建立了ENIAC计算机（电子数字积分计算机），用于计算导弹
                            轨道。
1943年                                   英国建立了破译德国密码的Colossus（巨人）。
1944年                                   哈佛大学和IBM开发出使用IBM穿孔卡的Mark1。
1945年                                   John von Neumann描述了多用途的电子数字计算机，带有存储的程序，成为随后大多数计算机的基础。
1947年           William Shockley发明了晶体管，是真空电子管固态的、精密的改进。
1954年                                   Texas Instruments宣布开始硅晶体管的商业生产。
1969年                                   Intel的Ted Hoff设计了可以根据数据听从指令并执行简单功能的芯片。
1981年                                   IBM推出了使用Intel16位8086处理器的个人计算机。
1984年                                   Apple推出Macintosh，一种使用鼠标和图形界面的计算机。
 
 
在打开个人计算机的电源之前，它只是一堆没有生命的金属片、塑料、金属轨迹、小型硅片。按下启动开关时，小小的电脉冲（只有3~5伏左右）启动了一连串事件，神奇的给大块头的计算机赋予生命。
然而，即使有生命的活力，PC刚开始仍然是愚昧的。在检验有哪些部件安装就位并在工作时，PC具有一些原始的自我感官，就像那些从昏迷中醒来的病人，要检查一下他们自己是否还四肢俱全、所有关节是否还活动一样。但除了清点一下自己的存货清单外，刚刚醒来的PC还不能真正发挥作用，当然，根本就不用去想具有智能了。
顶多，刚刚醒来的PC可以寻求智能，这种智能就是：以操作系统的方式，给PC原始的、变形虫式存在方式赋予结构。然后，以应用程序软件的形式—程序，告诉PC如何比我们更迅速、更准确的完成任务，从而开始了真正的教育过程。PC称为了超越老师的学生。
但是，在每次打开时，并不是所有类型的计算机都必须忍受这种充满痛苦的复活过程。我们每天都遇到许多计算机，一经启动，便迸发出成熟饱满的生命。你可能没有把它们当成计算机，但它们就是计算机：计算器、汽车电子点火器、微波炉计时器、VCR中深不可测的程序设备。这些设备与你桌上的计算机是不同的，其区别就是硬连线。这种构造的计算机，所完成的惟一任务是硬连线的，其效果极为显著。但这意味着它们更像白痴学者，而不是哲人。
PC之所以成为如此神奇的设备，是因为每次打开时，它都是空白的，能够实现你的创造性（或者说，更多的是专业程序设计人员的创造性）设想出的任何PC力所能及的工作。它是计算的机器、艺术家的画布、神奇的打字机、不出错的会计以及其他工具的宿主。要想把它从一个角色转换为另一个角色，只要求设置一些埋藏在微芯片核心的微型开关，键入命令，或者用鼠标单击屏幕上的一些小图标，便可完成任务。
这类智能是脆弱而短命的。电子的涌浪猛烈冲击时，所有那些成千上百万个微型开关不断地翻转开关。只要有一个开关偏离指令或偶尔发生读取错误，就会使这个奇妙的有生命的假人进入紧张症状态。或者，你按一下“关闭”开关，一度鲜活的人造生命就会一声不吭的死去。
然而，下次打开时，生命又重新开始。
 
 
 
1956年    John Bachus和他的IBM工作小组开发了FORTRAN，这是第一个高级编程语言。
1960年          LISP作为设计用于编写人工智能程序的第一种编程语言出台亮相。
1965年          面向对象的语言由于Simula的出现，得到了早期的提高，它是由Kisten Nygaard和OleJohn Dahl共同开发的。
1969年         Bill Gates和Paul Allen自称湖边编程组（Lakeside Programming Group），和Computer Center Corporation签订了一项协议，以报告软件PDP-10中的错误，来交换上机时间。
1975年          在给Paul Allen的一封信中，比尔.盖茨使用Microsoft来提及他们的合作公司。
1976年          微软公司开展了他的第一个广告活动，称作The Legend of MicroKid。
1977年          美国政府采用了IBM的加密技术标准，来保护信息在政府机构里的机密性，这个标准是解开编码消息的密钥。
1978年          微软公司宣布它的第三代语言产品Microsoft COBOL-80。销售额超过100万美元。
1979年          微软公司推出了可用于16位8086微处理器的Microsoft BASIC语言。作为用于16位机器的第一个版本的高级语言，它标志着广泛应用这些处理器的开始。
1981年    IBM推出了它的个人计算机，它可以使用微软公司的16位操作系统（MS-DOS 1.0），并且支持微软的BASIC、COBOL、PASCAL以及其他的产品。
1983年  微软公司推出了它的字处理程序，即支持MS-DOS 1.00的Microsoft Word。它最初被称Multi-Tool Word。
1985年  Aldus发布了用于Macintosh计算机的PageMaker程序，从而引起了人们对桌面出版方面的兴趣。
1989年          Maxis发布了SimCity，这个视频游戏对与模拟游戏作为一种新类型的教育和娱乐软件投放市场起了很大作用。
1995年          推出Windows 95操作系统。
1997年    深蓝击败了国际象棋世界冠军。
1998年    Windows操作系统推出。 
...
微芯片：
1823年          Baron Jons Jakob Berzelius分离出了一种元素Si， 后来， 这种元素成了微芯片的基本组成成分。
1886年          拥有MegaHertz（MHz）荣誉的Heinrich Rudolf Hertz， 证明电子以光速传输。
1926年           人们首次申请了半导体晶体管专利。该晶体管可将电流传给计算机，使数据可以通过计算机传递。
1939年         John Atanasoff将ABC（一个原型计算机）概念化了。这是第一次使用真空管，它也是第一台电子数字计算机。
1943年          出现了第一台电子通用目的的计算机——ENIAC，它有19000个真空管，1500个继电器，消耗大约200千瓦的电能。
1948年    第一台商用计算机出现，称为UNIVAC，贝尔（Bell labs）实验室的John Bardeen 和    William Shockley 申请了第一个晶体管的专利。
1956年    第一台晶体管化的计算机TX-O（Transistorized Experimental computer）由美国麻 省理工学院（Massachusetts Institute of Technology，MIT）完成。
1960年         IBM在纽约研制第一台成批生产晶体管的自动化设备。
1964年          戈登.摩尔（Gordon Moore）预言集成电路的复杂性将每年翻一番，后来，这一预言成了有名的摩尔定律（Moore’s Law）。这一定律在摩尔的论文中发表，曾经刊登在杂志上。
1968年         在加州的Santa Clara创建了Intel公司，其创始者为Fairchild的“元老”Robert Noyce与Gordon Moore（分别为1#和2#雇员），后来Andy Grove离开了Fairchild，并成了Intel的4#雇员。
1974年         Intel 8080微处理器成了第一台个人计算机Altair的大脑，计算机爱好者可以花395美元买到该计算机的散件。
1981年          Bill Gate（比尔.盖茨）说，640K的内存对于每个人都应该是足够了。
1985年  Motorola（摩托罗拉）宣告68040，一个32位的25MHz的微处理器诞生了。  
...
[Wokwi - World's most advanced ESP32 Simulator 免费电子实验模拟平台，不用买硬件就能在电脑上测试电路和编程](https://wokwi.com)
