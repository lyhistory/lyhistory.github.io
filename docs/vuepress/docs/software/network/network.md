...
+ Layer 1: Physical layer (network cable)

### 1.0 数据通信流程

[更细节的过程参考：透视路由器-跟踪一个从内网设备发往互联网的数据包](/software/network/layer_x.md#层级剖析)
...
TLS握手发生在TCP握手结束之后，具体参考《publickey_infrastructure.md/[#](/software/highlevel/core_concepts_publickey_infrastructure.md#_3-1-ssl-tls)3.1 SSL/TLS》
...
### 5.3 [TCP相关](/software/network/layer4_tcp_protocol.md)
