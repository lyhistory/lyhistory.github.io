...
#### 介词
✅ on the playground/farm（最标准，美式英式都通用）
✅ in the playground（英式也常见，强调"在游乐场这个区域内"）
⚠️ at the playground​ — 语法没错，但 at​ 只表"在某某地点"，偏方位参照，不够精准

Let's meet at​ the playground.✅（在这儿碰头）
The kids are playing on/in​ the playground.✅（在场上玩）

in/on bed
规律：只要 bed 指的是「人处于躺卧/睡眠状态」，一律用 in bed（不加 the）
	I'm in bed.              ✅ 我在床上（躺着呢，睡觉/休息中）
	I read in bed every night. ✅ 每晚在床上看书
	Don't eat in bed!         ✅ 别在床上吃东西
	He stayed in bed all day. ✅ 他一整天都赖在床上
规律：on the bed = 在床这个物体的「表面」上。床面是一个平台（platform），你站在或放在它的上面（on），不是在它里面。
	Put the laundry on the bed.    ✅ 把衣服放在床面上
...
Done: dressing & plating art — chocolate sauce + pastries.
这里 dressing不是"穿衣服"，是淋酱 / 装饰（西厨用语，给甜品或沙拉做最后调味装饰那一步）
plating= 把食物摆上盘的最终出品动作
配糕点（pastry 复数是 pastries，指可颂、塔、千层这类精致烘焙，不是普通蛋糕）
