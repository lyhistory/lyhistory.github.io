...
#### PREPOSITION Verb / intransitive preposition, VERB-PREPOSITION COMBINATIONS
consent to
subject to
...
dongle is a small piece of hardware that connects to another device to provide it with additional functionality.
distro
